...
public class FarmingMod {
	...
	public static final CreativeTabs tabCookwares = new NewCreativeTabs(
			"cookwares", 272);
	public static final CreativeTabs tabMaterials = new NewCreativeTabs(
			"foodmaterials", 353);
	public static final CreativeTabs tabPlants = new NewCreativeTabs("plants",
			360);
	...
	public void preinit(FMLPreInitializationEvent event) {
		...
		try {
			cfg.load();
			cookingTable = new BlockCookingTable(cfg.getBlock("CookingTable",
					1063).getInt());
		...
		for (Items i : items) {
			GameRegistry.registerItem(i, "FarmingModItem".concat(Integer
					.toString(i.getItemStackLimit())));
			MinecraftForgeClient.registerItemRenderer(i.itemID,
